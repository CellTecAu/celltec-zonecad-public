...
export const POST_PROFILE = {
  ...
  z65:       { w: 65, h: 65, wall: 2.5 }, // Z65 range — 65×65×2.5 SHS
};
...
export const FOOTPLATE = {
  ...
  FPZ:  { w: 75,  h: 180, holes: 2, offsetX:  0, offsetY:   0, holeDia: 14 }, // Z65 flat foot — portrait 75×180×8, 2×Ø14 @ ±70 (from zoneforge harvested part)
};
...
// CONFIRMED against zoneforge (2026-07-20), which harvests the real Z65-PB: the
// bracket bolts flat to the 65 post face, and a panel of c-c − 80 (what
// spanRunLength gives here) lands its edge vertical dead on 52.5 and the bracket
// on the post face. zoneforge had copied the ALLOY rule (c-c − 100 → 62.5) onto
// Z65 and has been corrected to match this.
